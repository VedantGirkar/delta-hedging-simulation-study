    ...
    *,
    ...
    while True:
        stock_paths = simulate_multiple_gbm_paths(
            S0=S0, mu=MU, sigma=SIGMA, maturity=T,
        ...
        covers   = interval_covers_value(mean_ci["lower"], mean_ci["upper"], benchmark_price_total)
        ...
        final_result = {
            ...
            "hedge_results":        hedge_result["all_results"],   # ← full per-path rows
        }
